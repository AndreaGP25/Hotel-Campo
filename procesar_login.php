...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        if ($usuario && password_verify($password, $usuario['password'])) {
            ...
            // registro de fecha y hora de inicio de sesión
            // para detectar sesiones que superaron las 48 horas
            $_SESSION['login_time'] = time();

            // registro en tabla sesiones
            ...
            // Modal de error (idéntico al original)
            echo "
            ...
            <style>
                ...
                .modal-body  { font-size: 16px; color: #555; margin-bottom: 20px; font-family: 'Montserrat', sans-serif; }
