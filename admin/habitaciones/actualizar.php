        ...
        <form action="/campo/actualizar_habitacion.php" class="formulario-crear" method="POST"
            ...
            <fieldset>
                ...
                <input type="text" name="titulo" id="titulo" class="input"
                    value="<?= htmlspecialchars($habitacion['titulo']) ?>" required>
                ...
                <textarea name="descripcion" id="descripcion" class="textarea" rows="4"
                    required><?= htmlspecialchars($habitacion['descripcion']) ?></textarea>

                <label for="categoria">Categoría:</label>
                <select id="categoria" name="categoria" required>
                    <option value="Estandar" <?= $habitacion['categoria'] === 'Estandar' ? 'selected' : '' ?>>Estándar
                    </option>
                    <option value="Superior" <?= $habitacion['categoria'] === 'Superior' ? 'selected' : '' ?>>Superior
                    </option>
                </select>
            ...
            <div>
                <ul id="iconos">
                    <li><a href="https://www.facebook.com/" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg"
                                width="16" height="16" fill="currentColor" class="bi bi-facebook icono"
                                viewBox="0 0 16 16">
                                <path
                    ...
                    <li><a href="https://www.instagram.com/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg"
                                width="16" height="16" fill="currentColor" class="bi bi-instagram icono"
                                viewBox="0 0 16 16">
                                <path
