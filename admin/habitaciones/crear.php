...
<body>
    ...
    <main class="contenedor">
        <h1 class="titulo-admin">Crear</h1>
        <a href="/public/admin/indexAdmin.php" class="botones btn-crud mayusculas">Volver</a>

        <form action="/public/crear_habitacion.php" class="formulario-crear" method="POST" enctype="multipart/form-data">
            <fieldset>
                ...
                <input type="file" name="imagen" id="imagen" class="input-file" accept="image/jpeg, image/png, image/avif" required>
